...
function EventCard(props) {
  ...
  const Book = () => {
    Axios.get(
      "https://eventhub-t514.onrender.com/eventRoute/check-user/" + user
    )
      .then((res) => {
        if (res.status === 200) {
          if (res.data != null) {
            ...
            if (check) {
              ...
              Axios.all([
                Axios.put(
                  "https://eventhub-t514.onrender.com/eventRoute/update-user/" +
                    res.data._id,
                  userData
                )
                  .then((updateResponse) => {
                ...
                Axios.put(
                  "https://eventhub-t514.onrender.com/eventRoute/update-event/" +
                    _id,
                  eventData
                )
  ...
  const deleteEvent = () => {
    Axios.all([
      Axios.delete(
        "https://eventhub-t514.onrender.com/eventRoute/delete-event/" + _id
      )
        .then((res) => {
          if (res.status === 200) {
      ...
      Axios.get("https://eventhub-t514.onrender.com/eventRoute/user-list").then(
        (userResponse) => {
